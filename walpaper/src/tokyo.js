...
const clock = document.getElementsByClassName('clock-tokyo')[0]
...
let dialHours = document.getElementsByClassName('clock-tokyo__dial-hour')
...
const handPivot = document.getElementById('hand-pivot-tokyo')
...
const hoursHand = document.getElementById('hours-hand-tokyo')
const minutesHand = document.getElementById('minutes-hand-tokyo')
const secondsHand = document.getElementById('seconds-hand-tokyo')
...
document.getElementById('clock-tokyo-status').innerHTML = dt.toLocaleString('en-US', { timeZone: worldTimes.tokyo.timezone }).match(/[a-z]+/gi).toString();
_localTime = dt.toLocaleString('en-US', { timeZone: worldTimes.tokyo.timezone }).split(',')[1].replace(/\s[a-z]+/gi, '').split(':');
...
const init = () => {
    document.getElementById('clock-tokyo-text').innerHTML = worldTimes.tokyo.text;
